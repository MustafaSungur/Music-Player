...
const darkMode = document.querySelector(".card");
const darkModeIcon = document.querySelector(".dark-mode span i");

const player = new MusicPlayer(musicList);
window.addEventListener("load", () => {
  if (localStorage.getItem("index")) {
    player.index = parseInt(localStorage.getItem("index"));
  }
  let music = player.getMusic();
  displayMusic(music);
  displayMusicList(player.musicList);
  isPlayingNow();
  audio.currentTime = parseFloat(localStorage.getItem("time"));

  if (localStorage.getItem("mode") != "") {
    for (let li of document.querySelectorAll("#music-list li")) {
      li.classList.add(localStorage.getItem("mode"));
    }
    darkMode.classList.add(localStorage.getItem("mode"));
  }
});
...
darkModeIcon.addEventListener("click", () => {
  ...
  if (darkMode.classList.contains("dark")) {
    darkModeIcon.classList = "fa-regular fa-moon";
    localStorage.setItem("mode", "dark");
  } else {
    darkModeIcon.classList = "fa-solid fa-moon";
